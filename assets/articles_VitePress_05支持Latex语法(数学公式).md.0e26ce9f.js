import{_ as e,o as a,c as n,k as s,Q as t}from"./chunks/framework.2516552c.js";const x=JSON.parse('{"title":"支持Latex数学公式","description":"","frontmatter":{},"headers":[],"relativePath":"articles/VitePress/05支持Latex语法(数学公式).md","filePath":"articles/VitePress/05支持Latex语法(数学公式).md","lastUpdated":null}'),l={name:"articles/VitePress/05支持Latex语法(数学公式).md"},o=t(`<h1 id="支持latex数学公式" tabindex="-1">支持Latex数学公式 <a class="header-anchor" href="#支持latex数学公式" aria-label="Permalink to &quot;支持Latex数学公式&quot;">​</a></h1><p>参考：<a href="https://blog.csdn.net/delete_you/article/details/130815350" target="_blank" rel="noreferrer">https://blog.csdn.net/delete_you/article/details/130815350</a></p><p>目的：支持Latex数学公式</p><p>分析：由于目前vitepress最新版依旧采用markdown-it作为md渲染库，默认并不支持latex语法，所以我们需要将其替换为另一个渲染库才可以。</p><p>这里使用最新的 <code>markdown-it-mathjax3</code> 作为渲染库。</p><p>先安装。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">npm install markdown-it-mathjax3 -D</span></span>
