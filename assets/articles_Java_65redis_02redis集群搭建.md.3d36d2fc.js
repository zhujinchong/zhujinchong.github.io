import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.2516552c.js";const f=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/65redis/02redis集群搭建.md","filePath":"articles/Java/65redis/02redis集群搭建.md","lastUpdated":1698198415000}'),l={name:"articles/Java/65redis/02redis集群搭建.md"},p=a(`<p>单机启动</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 修改配置</span></span>
