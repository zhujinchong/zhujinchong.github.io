import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.2516552c.js";const m=JSON.parse('{"title":"Spring Data Redis","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/51SpringBoot/04缓存Redis.md","filePath":"articles/Java/51SpringBoot/04缓存Redis.md","lastUpdated":null}'),l={name:"articles/Java/51SpringBoot/04缓存Redis.md"},p=e(`<h1 id="spring-data-redis" tabindex="-1">Spring Data Redis <a class="header-anchor" href="#spring-data-redis" aria-label="Permalink to &quot;Spring Data Redis&quot;">​</a></h1><h2 id="快速入门" tabindex="-1">快速入门 <a class="header-anchor" href="#快速入门" aria-label="Permalink to &quot;快速入门&quot;">​</a></h2><p>引入依赖</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;!-- redis 缓存 --&gt;</span></span>
