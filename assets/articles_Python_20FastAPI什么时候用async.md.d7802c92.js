...
<span class="line"><span style="color:#24292e;">    uvicorn.run(app, host=&quot;0.0.0.0&quot;, port=8000)</span></span></code></pre></div><p>我们并发100个请求分别测试这4个接口。 结果： /a接口：100秒 /b接口：1秒 /c接口：1秒 /d接口：3秒</p><p><strong>就像官方所说，如果你不清楚你函数里的调用是否异步，那就定义为普通函数。因为它可以采用多线程的方式解决。反之，定义了async函数，里面却是同步的调用（第一个函数），那么这将慢的是灾难！</strong></p>`,27),o=[l];function t(c,i,r,y,u,d){return a(),n("div",null,o)}const _=s(p,[["render",t]]);export{q as __pageData,_ as default};
