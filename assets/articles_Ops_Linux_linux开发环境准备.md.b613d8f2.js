import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.2516552c.js";const g=JSON.parse('{"title":"虚拟机环境","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Ops/Linux/linux开发环境准备.md","filePath":"articles/Ops/Linux/linux开发环境准备.md","lastUpdated":null}'),p={name:"articles/Ops/Linux/linux开发环境准备.md"},o=e(`<p>按照教程来</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">1. 安装VMWare</span></span>
