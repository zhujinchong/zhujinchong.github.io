import{_ as s,o as a,c as e,Q as n}from"./chunks/framework.2516552c.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/53Arthus/index.md","filePath":"articles/Java/53Arthus/index.md","lastUpdated":null}'),p={name:"articles/Java/53Arthus/index.md"},l=n(`<p>启动</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">注意事项：用启动项目的用户登录arthus</span></span>
