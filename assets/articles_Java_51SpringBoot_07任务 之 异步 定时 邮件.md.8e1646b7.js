import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.2516552c.js";const h=JSON.parse('{"title":"异步任务","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/51SpringBoot/07任务 之 异步 定时 邮件.md","filePath":"articles/Java/51SpringBoot/07任务 之 异步 定时 邮件.md","lastUpdated":1698198415000}'),l={name:"articles/Java/51SpringBoot/07任务 之 异步 定时 邮件.md"},p=a(`<h1 id="异步任务" tabindex="-1">异步任务 <a class="header-anchor" href="#异步任务" aria-label="Permalink to &quot;异步任务&quot;">​</a></h1><p>如果有一个方法非常耗时，这时就需要用异步任务。</p><p>1、启动类开启异步任务，加上注解<code>@EnableAsync</code></p><p>2、定义一个异步方法，加上注解<code>@Async</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Service</span></span>
