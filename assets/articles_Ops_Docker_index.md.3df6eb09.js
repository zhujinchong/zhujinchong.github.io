...
<span class="line"><span style="color:#24292e;">docker-compose stop      # 停止服务</span></span></code></pre></div><h1 id="_9-可视化工具" tabindex="-1">9 可视化工具 <a class="header-anchor" href="#_9-可视化工具" aria-label="Permalink to &quot;9 可视化工具&quot;">​</a></h1><p>介绍两个：</p><ul><li>轻量级：Portainer</li><li>重量级：CAdvisor监控收集数据+InfluxDB存储数据+Granfana展示图标 <ul><li>CAdvisor：容器资源监控工具，包括CUP、磁盘、网络、内存等。默认存储2分钟。</li><li>InfluxDB：开源分布式时序、事件和指标数据库，无需外部依赖。</li><li>Granfana：开源可视化平台，支持多种数据源：InfluxDB, MySQL, ES等。</li></ul></li></ul><p>其中CIG三剑客可以直接docker编排安装。略。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
<span class="line"><span style="color:#e1e4e8;">	&quot;code&quot;: 200,  //状态码</span></span>
<span class="line"><span style="color:#e1e4e8;">	&quot;msg&quot;: &quot;success，后台正在飞速上传文件，请耐心等待&quot;,  //提示信息</span></span>
<span class="line"><span style="color:#e1e4e8;">	&quot;data&quot;: [</span></span>
<span class="line"><span style="color:#e1e4e8;">		{</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_id&quot;: &quot;1b6c0781fb9245b2973504cb031cc2f3&quot;,  //文件id</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_name&quot;: &quot;网易有道智云平台产品介绍2023.6.ppt&quot;,  //文件名</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;status&quot;: &quot;gray&quot;  //文件状态（red：入库失败-切分失败，green，成功入库，yellow：入库失败-milvus失败，gray：正在入库）</span></span>
<span class="line"><span style="color:#e1e4e8;">		},</span></span>
<span class="line"><span style="color:#e1e4e8;">		{</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_id&quot;: &quot;aeaec708c7a34952b7de484fb3374f5d&quot;,</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_name&quot;: &quot;有道知识库问答产品介绍.pptx&quot;,</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;status&quot;: &quot;gray&quot;</span></span>
<span class="line"><span style="color:#e1e4e8;">		},</span></span>
<span class="line"><span style="color:#e1e4e8;">		{</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_id&quot;: &quot;8ee98a88457c414a986a09c536fedde9&quot;,</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_name&quot;: &quot;韦小宝身份证.jpg&quot;,</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;status&quot;: &quot;gray&quot;</span></span>
<span class="line"><span style="color:#e1e4e8;">		},</span></span>
<span class="line"><span style="color:#e1e4e8;">		{</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_id&quot;: &quot;67af479f907b497cadb30c6e4b2d3fbc&quot;,</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;file_name&quot;: &quot;成长中心-辅导老师日常问题文档.pdf&quot;,</span></span>
<span class="line"><span style="color:#e1e4e8;">			&quot;status&quot;: &quot;gray&quot;</span></span>
<span class="line"><span style="color:#e1e4e8;">		}</span></span>
<span class="line"><span style="color:#e1e4e8;">	]  //文件列表</span></span>
<span class="line"><span style="color:#e1e4e8;">}</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">{</span></span>
<span class="line"><span style="color:#24292e;">	&quot;code&quot;: 200,  //状态码</span></span>
<span class="line"><span style="color:#24292e;">	&quot;msg&quot;: &quot;success，后台正在飞速上传文件，请耐心等待&quot;,  //提示信息</span></span>
<span class="line"><span style="color:#24292e;">	&quot;data&quot;: [</span></span>
<span class="line"><span style="color:#24292e;">		{</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_id&quot;: &quot;1b6c0781fb9245b2973504cb031cc2f3&quot;,  //文件id</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_name&quot;: &quot;网易有道智云平台产品介绍2023.6.ppt&quot;,  //文件名</span></span>
<span class="line"><span style="color:#24292e;">			&quot;status&quot;: &quot;gray&quot;  //文件状态（red：入库失败-切分失败，green，成功入库，yellow：入库失败-milvus失败，gray：正在入库）</span></span>
<span class="line"><span style="color:#24292e;">		},</span></span>
<span class="line"><span style="color:#24292e;">		{</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_id&quot;: &quot;aeaec708c7a34952b7de484fb3374f5d&quot;,</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_name&quot;: &quot;有道知识库问答产品介绍.pptx&quot;,</span></span>
<span class="line"><span style="color:#24292e;">			&quot;status&quot;: &quot;gray&quot;</span></span>
<span class="line"><span style="color:#24292e;">		},</span></span>
<span class="line"><span style="color:#24292e;">		{</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_id&quot;: &quot;8ee98a88457c414a986a09c536fedde9&quot;,</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_name&quot;: &quot;韦小宝身份证.jpg&quot;,</span></span>
<span class="line"><span style="color:#24292e;">			&quot;status&quot;: &quot;gray&quot;</span></span>
<span class="line"><span style="color:#24292e;">		},</span></span>
<span class="line"><span style="color:#24292e;">		{</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_id&quot;: &quot;67af479f907b497cadb30c6e4b2d3fbc&quot;,</span></span>
<span class="line"><span style="color:#24292e;">			&quot;file_name&quot;: &quot;成长中心-辅导老师日常问题文档.pdf&quot;,</span></span>
<span class="line"><span style="color:#24292e;">			&quot;status&quot;: &quot;gray&quot;</span></span>
<span class="line"><span style="color:#24292e;">		}</span></span>
<span class="line"><span style="color:#24292e;">	]  //文件列表</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,216),E=[h];function g(b,v,q,F,C,_){return n(),a("div",null,E)}const A=s(m,[["render",g]]);export{D as __pageData,A as default};
