import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.2516552c.js";const f=JSON.parse('{"title":"向量检索技术","description":"","frontmatter":{},"headers":[],"relativePath":"articles/算法/23LangChain/02工具总结.md","filePath":"articles/算法/23LangChain/02工具总结.md","lastUpdated":1698149129000}'),p={name:"articles/算法/23LangChain/02工具总结.md"},l=e(`<h1 id="向量检索技术" tabindex="-1">向量检索技术 <a class="header-anchor" href="#向量检索技术" aria-label="Permalink to &quot;向量检索技术&quot;">​</a></h1><p>向量库区别：</p><p>FAISS：facebook开源产品，也是鼻祖</p><p>Milvus：可应对大数据检索，分布式部署问题。</p><h1 id="rapidocr" tabindex="-1">RapidOCR <a class="header-anchor" href="#rapidocr" aria-label="Permalink to &quot;RapidOCR&quot;">​</a></h1><p>RapidOCR：基于PaddleOCR做的封装，转换为ONNX格式，做成工程化，支持多种编程语言、多种平台。</p><p>ONNX放到了whl包中，安装即可用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">pip install rapidocr-onnxruntime</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">pip install rapidocr-onnxruntime</span></span></code></pre></div><h1 id="bs4" tabindex="-1">bs4 <a class="header-anchor" href="#bs4" aria-label="Permalink to &quot;bs4&quot;">​</a></h1><blockquote><p>参考教程：<a href="https://blog.csdn.net/love666666shen/article/details/77512353" target="_blank" rel="noreferrer">https://blog.csdn.net/love666666shen/article/details/77512353</a></p></blockquote><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">pip install beautifulsoup4</span></span>
...
<span class="line"><span style="color:#24292e;">    fp.close()</span></span></code></pre></div>`,18),o=[l];function t(r,c,i,d,y,m){return a(),n("div",null,o)}const g=s(p,[["render",t]]);export{f as __pageData,g as default};
