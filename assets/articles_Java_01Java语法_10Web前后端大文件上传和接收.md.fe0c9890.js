import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.2516552c.js";const m=JSON.parse('{"title":"1. 前端使用js的BLOB对象分片","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/01Java语法/10Web前后端大文件上传和接收.md","filePath":"articles/Java/01Java语法/10Web前后端大文件上传和接收.md","lastUpdated":1698198415000}'),l={name:"articles/Java/01Java语法/10Web前后端大文件上传和接收.md"},p=a(`<h1 id="_1-前端使用js的blob对象分片" tabindex="-1">1. 前端使用js的BLOB对象分片 <a class="header-anchor" href="#_1-前端使用js的blob对象分片" aria-label="Permalink to &quot;1. 前端使用js的BLOB对象分片&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">let curFile = $(&quot;#crmImportForm #importFile&quot;)[0].files[0];</span></span>
