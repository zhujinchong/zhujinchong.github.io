...
<span class="line"><span style="color:#24292e;">split  对文件分割（分成小份）</span></span></code></pre></div><h1 id="启动脚本" tabindex="-1">启动脚本 <a class="header-anchor" href="#启动脚本" aria-label="Permalink to &quot;启动脚本&quot;">​</a></h1><p>启动</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/sh</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">PORT=8300</span></span>
<span class="line"><span style="color:#e1e4e8;">nohup java xxx.jar --port=$PORT &gt; /dev/null 2&gt;&amp;1 &amp;</span></span>
<span class="line"><span style="color:#e1e4e8;">echo &quot;$!&quot; &gt; pid</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">#!/bin/sh</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">PORT=8300</span></span>
<span class="line"><span style="color:#24292e;">nohup java xxx.jar --port=$PORT &gt; /dev/null 2&gt;&amp;1 &amp;</span></span>
<span class="line"><span style="color:#24292e;">echo &quot;$!&quot; &gt; pid</span></span></code></pre></div><p>停止</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/sh</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">kill -9 \`cat pid\`</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">#!/bin/sh</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">kill -9 \`cat pid\`</span></span></code></pre></div>`,75),o=[l];function c(t,i,r,d,h,u){return a(),n("div",null,o)}const q=s(p,[["render",c]]);export{g as __pageData,q as default};
