import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.2516552c.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Ops/Linux/02Shell脚本之服务启停脚本.md","filePath":"articles/Ops/Linux/02Shell脚本之服务启停脚本.md","lastUpdated":null}'),p={name:"articles/Ops/Linux/02Shell脚本之服务启停脚本.md"},l=e(`<p>启动脚本startup.sh</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/sh</span></span>
