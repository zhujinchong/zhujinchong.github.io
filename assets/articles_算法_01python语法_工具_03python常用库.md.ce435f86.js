import{_ as s,o as a,c as e,Q as n}from"./chunks/framework.2516552c.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/算法/01python语法&工具/03python常用库.md","filePath":"articles/算法/01python语法&工具/03python常用库.md","lastUpdated":1698149129000}'),p={name:"articles/算法/01python语法&工具/03python常用库.md"},l=n(`<p>Counter：计数器</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">from collections import Counter</span></span>
