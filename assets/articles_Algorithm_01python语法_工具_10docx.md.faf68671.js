import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.2516552c.js";const h=JSON.parse('{"title":"window下doc docx互转，转pdf","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Algorithm/01python语法&工具/10docx.md","filePath":"articles/Algorithm/01python语法&工具/10docx.md","lastUpdated":null}'),e={name:"articles/Algorithm/01python语法&工具/10docx.md"},l=p(`<h1 id="window下doc-docx互转-转pdf" tabindex="-1">window下doc docx互转，转pdf <a class="header-anchor" href="#window下doc-docx互转-转pdf" aria-label="Permalink to &quot;window下doc docx互转，转pdf&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">from win32com import client</span></span>
