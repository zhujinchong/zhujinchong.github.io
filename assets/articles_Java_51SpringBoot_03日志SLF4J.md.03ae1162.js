...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h2 id="配置文件详解" tabindex="-1">配置文件详解 <a class="header-anchor" href="#配置文件详解" aria-label="Permalink to &quot;配置文件详解&quot;">​</a></h2>`,14),p=[t];function o(c,i,r,g,y,u){return n(),a("div",null,p)}const h=s(e,[["render",o]]);export{q as __pageData,h as default};
