import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.2516552c.js";const h=JSON.parse('{"title":"1  快速入门","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/51SpringBoot/00SpringBoot.md","filePath":"articles/Java/51SpringBoot/00SpringBoot.md","lastUpdated":null}'),p={name:"articles/Java/51SpringBoot/00SpringBoot.md"},l=e(`<h1 id="_1-快速入门" tabindex="-1">1 快速入门 <a class="header-anchor" href="#_1-快速入门" aria-label="Permalink to &quot;1  快速入门&quot;">​</a></h1><p>1、新建一个maven项目（有MySql数据库）</p><p>2、在pom.xml中导入依赖</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">	&lt;dependencies&gt;</span></span>
