import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.2516552c.js";const h=JSON.parse('{"title":"/dev/null","description":"","frontmatter":{},"headers":[],"relativePath":"articles/全栈/Linux/03重要命令.md","filePath":"articles/全栈/Linux/03重要命令.md","lastUpdated":null}'),p={name:"articles/全栈/Linux/03重要命令.md"},l=e(`<h1 id="dev-null" tabindex="-1">/dev/null <a class="header-anchor" href="#dev-null" aria-label="Permalink to &quot;/dev/null&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">0 标准输入</span></span>
