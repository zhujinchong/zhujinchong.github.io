import{_ as s,o as a,c as e,Q as n}from"./chunks/framework.2516552c.js";const m=JSON.parse('{"title":"内存","description":"","frontmatter":{},"headers":[],"relativePath":"articles/全栈/Linux/04Linux性能监控.md","filePath":"articles/全栈/Linux/04Linux性能监控.md","lastUpdated":1698198415000}'),l={name:"articles/全栈/Linux/04Linux性能监控.md"},p=n(`<h1 id="内存" tabindex="-1">内存 <a class="header-anchor" href="#内存" aria-label="Permalink to &quot;内存&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[zjc@localhost ~]$ free -m</span></span>
