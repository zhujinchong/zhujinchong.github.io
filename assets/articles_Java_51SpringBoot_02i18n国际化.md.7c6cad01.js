import{_ as s,o as e,c as a,Q as n}from"./chunks/framework.2516552c.js";const h=JSON.parse('{"title":"i18n简介","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/51SpringBoot/02i18n国际化.md","filePath":"articles/Java/51SpringBoot/02i18n国际化.md","lastUpdated":1698165159000}'),l={name:"articles/Java/51SpringBoot/02i18n国际化.md"},p=n(`<h1 id="i18n简介" tabindex="-1">i18n简介 <a class="header-anchor" href="#i18n简介" aria-label="Permalink to &quot;i18n简介&quot;">​</a></h1><h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h2><p>internationalization的i-n之间有18个单词，所以国际化也叫i18n。</p><p>Java作为跨平台语言，就给我们提供了一个工具类ResourceBundle实现国际化，核心思想是对不同的语言提供不同的资源文件。</p><p>可以是实现的功能：</p><ul><li>系统页面文字、前端交互信息、后台交互信息都能进行多语言切换；</li><li>手动进行系统语言切换；</li><li>系统根据浏览器的默认语言设置进行语言切换。</li></ul><h2 id="原理" tabindex="-1">原理 <a class="header-anchor" href="#原理" aria-label="Permalink to &quot;原理&quot;">​</a></h2><p>在Spring中，国际化主要通过<code>ResourceBundleMessageSource</code>这个类实现。</p><p>在SpringBoot通过<code>MessageSourceAutoConfiguration</code>为我们配置好了管理国际化资源文件的组件。</p><p>打开源码<code>org.springframework.boot.autoconfigure.context.MessageSourceAutoConfiguration</code></p><p>1\\里面规定了它的配置前缀</p><pre><code>@Bean
