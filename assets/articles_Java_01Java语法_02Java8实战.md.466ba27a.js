import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.2516552c.js";const m=JSON.parse('{"title":"函数式接口","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Java/01Java语法/02Java8实战.md","filePath":"articles/Java/01Java语法/02Java8实战.md","lastUpdated":null}'),l={name:"articles/Java/01Java语法/02Java8实战.md"},p=e(`<h1 id="函数式接口" tabindex="-1">函数式接口 <a class="header-anchor" href="#函数式接口" aria-label="Permalink to &quot;函数式接口&quot;">​</a></h1><h2 id="行为参数化" tabindex="-1">行为参数化 <a class="header-anchor" href="#行为参数化" aria-label="Permalink to &quot;行为参数化&quot;">​</a></h2><p>函数式编程可以简化代码，提交代码编程效率，是一种思想；Lambda表达式用来简化代码，是一种语法。</p><p>下面讲解函数式编程、Lambda表示式、行为参数化概念。</p><p>现有两个需求：</p><ul><li>筛选出重要大于150的苹果；</li><li>筛选出颜色为green的苹果</li></ul><p>解决方法：</p><ul><li>以下代码使用了策略设计模式，筛选策略是：重量、颜色；</li><li>将策略封装起来，用的时候选择其中一个。</li><li>我们将筛选策略以参数的形式传递给filterApples方法，多种行为/策略，一个参数，这就叫行为参数化。</li></ul><blockquote><p>行为参数化实现方法有：参数化方法、参数化类、匿名类、Lambda表达式。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">public interface ApplePredicate{ </span></span>
