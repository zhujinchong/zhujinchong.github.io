import{_ as a,o as s,c as n,Q as p}from"./chunks/framework.2516552c.js";const b=JSON.parse('{"title":"1. 生成数组所需格式不同","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Algorithm/01python语法&工具/02np.array()和np.mat()区别.md","filePath":"articles/Algorithm/01python语法&工具/02np.array()和np.mat()区别.md","lastUpdated":null}'),e={name:"articles/Algorithm/01python语法&工具/02np.array()和np.mat()区别.md"},l=p(`<p>参考 <a href="https://blog.csdn.net/Build_Tiger/article/details/79848808" target="_blank" rel="noreferrer">https://blog.csdn.net/Build_Tiger/article/details/79848808</a></p><h1 id="_1-生成数组所需格式不同" tabindex="-1">1. 生成数组所需格式不同 <a class="header-anchor" href="#_1-生成数组所需格式不同" aria-label="Permalink to &quot;1. 生成数组所需格式不同&quot;">​</a></h1><p>mat可以从字符串或列表中生成；</p><p>array只能从列表中生成</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">a = np.mat(&quot;1,2; 3,4&quot;)</span></span>
...
<span class="line"><span style="color:#24292e;">print(np.dot(a, b))</span></span>
<span class="line"><span style="color:#24292e;">print(np.multiply(a, b))</span></span>
<span class="line"><span style="color:#24292e;">print(a*b)</span></span></code></pre></div><p>end</p>`,11),t=[l];function o(c,r,i,d,y,h){return s(),n("div",null,t)}const m=a(e,[["render",o]]);export{b as __pageData,m as default};
